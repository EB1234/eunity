  ...
  <script src="<?= $this->assetUrl('js/jssor.slider-21.1.5.mini.js'); ?>"></script> -->
    ...
    <style>
        ...
        */
        ...
        .jssorb05 div, .jssorb05 div:hover, .jssorb05 .av {
            ...
            width: 16px;
            height: 16px;
            background: url(<?php $this->assetUrl('img/b05.png')?>) no-repeat;
            overflow: hidden;
            cursor: pointer;
        }
        ...
        */
        .jssora22l, .jssora22r {
            ...
            height: 58px;
            cursor: pointer;
            background: url(<?php $this->assetUrl('img/a22.png')?>) center center no-repeat;
            overflow: hidden;
        }
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position:absolute;display:block;background:url(<?php $this->assetUrl('img/loading.gif')?>) no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
        </div>
                ...
                <p id="age">
                      <?php
                          if($MembreMaitre->getAge() == 1){
                              ...
                              echo '<div>
                                      Age :' .' '.
                                      age($MembreMaitre->getAge()) . ' ans</div>';
                          }
                      ?>
                  </div>
